...
struct overrider {
    ...
    double operator ()(key index, double value);    /// @brief gets interpolated value for curve nr index, at time value. if nodata, returns -1
    ...
    void setOver(key nameVar = string(""), bool value = true);/// @brief to decide which curve to override for later simulations. Use index = -1 to override everything
