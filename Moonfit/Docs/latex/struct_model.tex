...
\begin{DoxyCompactList}\small\item\em Name of this model. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em the \textquotesingle{}official/global/external\textquotesingle{} name of each variable, when reading data / kinetics \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em computes the derivatives (at t) from position x \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em gives a correct set of parameters, if you don\textquotesingle{}t load other set. \end{DoxyCompactList}\item 
virtual void \mbox{\hyperlink{struct_model_affc6f838a87a8005f52240f4f7c21015}{finalize}} ()
\begin{DoxyCompactList}\small\item\em initialise, (parameters should be set before initializing) -\/ sets t = 0 if necessary. \end{DoxyCompactList}\item 
virtual void \mbox{\hyperlink{struct_model_ab427438468288f3a1eb2b3c3bb8bfb6e}{load\+Parameters}} (string file\+\_\+name)
\begin{DoxyCompactList}\small\item\em It can be helpful that the experiments notifies the model when a simulation is finished. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em reads parameters from a text file with format \+: \char`\"{}\+N\+B\+\_\+\+P\+A\+R\+A\+M\+S\textbackslash{}tparam1\textbackslash{}tparam2\textbackslash{}tparam3 ...\char`\"{} \end{DoxyCompactList}\item 
virtual void \mbox{\hyperlink{struct_model_aa41fdea625302654c9ae9ec4a538dfbd}{action}} (string name, double parameter)
\begin{DoxyCompactList}\small\item\em writes parameters from a text file with format \+: \char`\"{}\+N\+B\+\_\+\+P\+A\+R\+A\+M\+S\textbackslash{}tparam1\textbackslash{}tparam2\textbackslash{}tparam3 ...\char`\"{} \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em function to perform personnalized actions by the model by a name of action, \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em derivatives at time , updated each time the solver stops for output \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em frequency of saving/displaying data for kinetics \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em to set the \textquotesingle{}recording mode\textquotesingle{} to O\+N/\+O\+FF, and the frequency of recording \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em then, each time \mbox{\hyperlink{struct_model_ac41ad8a875de831705a12052513e991b}{initialise\+Done()}} is called, the kinetics is cleared, and \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em 4c -\/ to get the value of a particular variable at a particular time point during a simulation, \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em vectors that can be filled by the subclass \+: \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em to modify the value of a variable from the global ID of it \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em to get the value of a variable from its global ID \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em to know if a variable can be simulated by the model (from its global ID) \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em index of variables for this external name \end{DoxyCompactList}\item 
int \mbox{\hyperlink{struct_model_ae745db61bb0aea02bf130814a70b8529}{get\+Nb\+Params}} ()
\begin{DoxyCompactList}\small\item\em index of variables for this external name; raises an error if there are multiple... \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em 8 -\/ to get information on the (internal) variables. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em 9 -\/ Overriding certain variables with data, \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em 11 -\/ Internal functions \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em initial values of variables (size b\+Vars) \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em parameter values (size nb\+Params) \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em names of the variables \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em names of the parameters \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em During a simulation, these variables will be used by the solver. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em advised to do \textquotesingle{}t=0;\textquotesingle{} in the initialize function \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em variables at time t \end{DoxyCompactList}\item 
double \mbox{\hyperlink{struct_model_a9ebaf991e4335faedebf981f8694e2ad}{dt}}
\begin{DoxyCompactList}\small\item\em Simulates from t (not changed), to t + \+\_\+sec\+\_\+max, by calling one\+\_\+step. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em minimum dt used for simulations. The tunable dt will start at dt$\ast$10 and be limited between dt and dt$\ast$100 \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{struct_model_acc994d32aa30ba50f13e4f0c49c9bcf3}{save\+Kinetics}}
\begin{DoxyCompactList}\small\item\em automatically updated by the mother class \+: put to zero when \mbox{\hyperlink{struct_model_ac41ad8a875de831705a12052513e991b}{initialise\+Done()}} called and increased when the simulation diverges. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em sets the mode \+: simulates a kinetics to record or just simulate what you ask without stopping \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em the simule function call this to record data of a time point into the Cinetique. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em says if a variable is overrided (then, no need to calculate derivatives) if no U\+S\+E\+\_\+\+O\+V\+E\+R\+R\+I\+D\+E\+RS defined, then returns false ! So a program can use this function independently of the define options \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em internal way of managing kinetics (automatically used) \end{DoxyCompactList}\item 
...
{\footnotesize\ttfamily Model\+::\+Model (\begin{DoxyParamCaption}\item[{int}]{\+\_\+nb\+Vars,  }\item[{int}]{\+\_\+nb\+Params }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily Model\+::\+Model (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{struct_model}{Model}} \&}]{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
{\footnotesize\ttfamily void Model\+::action (\begin{DoxyParamCaption}\item[{string}]{name,  }\item[{double}]{parameter }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [virtual]}}
...
{\footnotesize\ttfamily void Model\+::derivatives (\begin{DoxyParamCaption}\item[{const vector$<$ double $>$ \&}]{x,  }\item[{vector$<$ double $>$ \&}]{dxdt,  }\item[{const double}]{t }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [virtual]}}
...
{\footnotesize\ttfamily void Model\+::load\+Parameters (\begin{DoxyParamCaption}\item[{string}]{file\+\_\+name }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [virtual]}}
...
{\footnotesize\ttfamily bool Model\+::over (\begin{DoxyParamCaption}\item[{int}]{index\+Local }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily void Model\+::set\+Overrider (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structoverrider}{overrider}} $\ast$}]{new\+Overrider = {\ttfamily nullptr} }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily void Model\+::set\+Value (\begin{DoxyParamCaption}\item[{string}]{name\+External\+Variable,  }\item[{double}]{val }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [virtual]}}
...
{\footnotesize\ttfamily void Model\+::simulate (\begin{DoxyParamCaption}\item[{double}]{\+\_\+sec\+\_\+max,  }\item[{\mbox{\hyperlink{struct_evaluator}{Evaluator}} $\ast$}]{E = {\ttfamily NULL} }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [virtual]}}
