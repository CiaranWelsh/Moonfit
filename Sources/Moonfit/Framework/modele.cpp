...
void modelAgentBased::simulate(double sec_max, Evaluator* E){
    ...
    if(!E) cerr << "WRN: modeleDividingAgents::simulate(), No Evaluator given\n";
    if(saveKinetics) newCinetiqueIfRequired(); else deleteCinetique();
...
void Model::action(string name, double parameter){cerr << "ERR- Model::action(string, double), this function should and was not implemented in the modele subclass\n";}
void Model::action(string name, vector<double> parameters){cerr << "ERR- Model::action(string, vector<double>), this function should and was not implemented in the modele subclass\n";}
