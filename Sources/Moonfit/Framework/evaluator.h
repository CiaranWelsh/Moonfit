...
#include <sstream>
using namespace std;
typedef int iteratorForEvaluator;   // see inside evaluator
...
/// Very important: in fitnessFunction() is defined the cost function to compare a simulation and data. Use the #define to choose which one

enum{ SQUARE_COST, SQUARE_COST_STD, LOG_COST, PROPORTION_COST};
enum{ NO_NORM, NORM_AVERAGE, NORM_NB_PTS, NORM_AVG_AND_NB_PTS};
...
/// 	- to save memory : no time kinetics are stored excepted wished values
